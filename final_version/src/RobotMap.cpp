...
// The AHRS is the gyro (like a compass)
...
// Initialize all the motor controller, encoder, and gyro components of the robot
// The Input/Output devices, like joysticks connected to the laptop, are initialized in OI.cpp
void RobotMap::init() {
	// If you don't know what it does, leave it there
